...
Payout curves, finalist comparisons, and year-over-year prize-pool growth remain available as tested helper logic, but they are no longer first-class dashboard visuals because they do not answer the primary revenue/profit-share question. The current seed now has compatible Wimbledon tournament-total 2026-over-2025, 2025-over-2024, 2024-over-2023, and 2023-over-2022 prize-money growth cases for future reuse.
