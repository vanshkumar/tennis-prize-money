...
Version `0.1.0` shipped a small seed dataset for 2025 Grand Slam men's singles prize money. The current unreleased dataset adds schema-version-2 numerator semantics, Australian Open 2025 and 2024 tournament-total competition-prize rows, one US Open total-player-compensation context row, and compatible primary-question Wimbledon 2025 and 2024 tournament-total financial slices. The active dataset is stored in:
