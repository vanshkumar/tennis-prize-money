...
Version `0.1.0` shipped a small seed dataset for 2025 Grand Slam men's singles prize money. The current unreleased dataset adds schema-version-2 numerator semantics, Australian Open 2025 and 2024 tournament-total competition-prize rows, US Open 2025 tournament-total competition prize money, US Open and Roland Garros total-player-compensation context rows, and compatible primary-question Wimbledon 2025 and 2024 tournament-total financial slices. The active dataset is stored in:
...
- Revenue and profit/surplus are available only for the Wimbledon tournament-total rows; other rows remain unavailable, not estimated or inferred. Current primary-question answerability coverage is `2/11`.
