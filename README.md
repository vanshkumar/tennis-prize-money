...
- `src/data/normalized/` contains normalized tournament economics records, including explicit prize-money scope, numerator-category metadata, Australian Open and US Open tournament-total numerator rows, and compatible Wimbledon tournament-total financial denominator rows.
...
- The seed covers 2025 men's singles competition-prize rows for the four Grand Slam tournaments, Australian Open 2025/2024, Wimbledon 2025/2024, and US Open 2025 tournament-total competition-prize rows, compatible Wimbledon operating-company denominators, and one US Open total-player-compensation context row.
